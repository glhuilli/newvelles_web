...
# Push Docker container to lightsail container
aws lightsail push-container-image --service-name newvelles-web-service --label newvelles-web-container --image newvelles-web-container
